...
kc_x = sp.sparse.diags([-kc_x_diag_1, kc_x_diag_1], [-N, N], shape=(N * N, N * N))

kc_y_diag_1 = DIAG_1/(2 * dh)
kc_y = sp.sparse.diags([-kc_y_diag_1, kc_y_diag_1], [-1, 1], shape=(N * N, N * N))
...
'''
#Numeric simulation for Q12
#matrix for U_n+1 Q12
M = I_N + dt/2*(kc_x + kc_y) - nu*dt/2*A
M_prime = I_N - dt/2*(kc_x + kc_y) + nu*dt/2*A
